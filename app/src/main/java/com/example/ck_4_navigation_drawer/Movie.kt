...
data class Movie(val nameFilm: String,val styles: String,
                 val rating: Float, val year: Int, val director: String,  val annotation: String, val wallpaper: String, val idFilm:Int)
